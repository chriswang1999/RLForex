...
class Policy(nn.Module):
    def __init__(self):
        ...
        self.affine1 = nn.Linear(256, 50, bias = True)
        self.hidden1 = nn.Linear(50, 50, bias = True)
        self.hidden2 = nn.Linear(50, 1, bias = True)
...
print ('run deep model by {}'.format(device))
